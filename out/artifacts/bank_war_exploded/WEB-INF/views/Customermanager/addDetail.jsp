		...
		<div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Customermanager/addDetailed.html" id="editfrom" method="post">
						...
						<div class="form-group">
							<label for="cid" class="col-sm-2 control-label">用户编号</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputPassword3" name="dname" placeholder="请输入产品名称">
							</div>
						</div>
