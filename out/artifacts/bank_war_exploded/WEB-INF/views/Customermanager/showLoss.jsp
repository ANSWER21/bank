								...
								<tr>
									...
									<td>
                                        <button class="btn btn-default btn-xs btn-info"
                                                onClick="location.href='${pageContext.request.contextPath}/Customermanager/editLoss.html?cid=${item.cid}&lcause=${item.lcause}'">编辑</button>
                                        <button class="btn btn-default btn-xs btn-danger btn-primary"
                                                onClick="location.href='${pageContext.request.contextPath}/Customermanager/removeLoss.html?cid=${item.cid}'">删除</button>
                                        <!--弹出框-->
									</td>
								</tr>
							</c:forEach>
