			...
			<div class="panel panel-default">
				...
				<script type="text/javascript">
					...
					$.ajax({
						...
						url: "<%=request.getContextPath()%>/executive/showContribution.html",    //请求发送到TestServlet处
						data: {},
						...
						success: function (performance) {
							...
							if (performance) {
								...
								for (var i = 0; i < performance.length; i++) {
									...
									data.push({value:performance[i].dtotal,name:performance[i].level});//挨个取出类别并填入类别数组
									console.log(data)
								}
