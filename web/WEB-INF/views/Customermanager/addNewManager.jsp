	...
	$(function() {
		$("#mid").blur(function () {
					...
					if (mid === "") {
						...
						var url = "<%=request.getContextPath()%>/Customermanager/checkmid.html";  // 请求的url
						$.post(
								url,
								{'mid': mid},
								function (data) {
		...
		<div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Customermanager/addNewManagered.html" id="editfrom" method="post">
