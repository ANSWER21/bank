		...
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<h1 style="text-align: center;">添加新产品</h1>
					</div>
				</div>
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Customermanager/addProducted.html" id="editfrom" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="pname" placeholder="请输入产品名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">期限类型</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  name="ptime" placeholder="请输入期限类型">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control"  name="pmoney" placeholder="请输入起点金额">
                            </div>
                        </div>
