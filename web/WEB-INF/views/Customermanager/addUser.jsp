	...
	$(function() {
		$("#cid").blur(function () {
					...
					if (cid === "") {
						...
						var url = "<%=request.getContextPath()%>/Customermanager/checkcid.html";  // 请求的url
						$.post(
								url,
								{'cid': cid},
								function (data) {
		...
		<div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Customermanager/addUsered.html" id="editfrom" method="post">
